...
export default function Login() {
  ...
  useEffect(() => {
    if (!loading && session) {
      const dest = role ? (location.state?.from?.pathname ?? "/dashboard") : "/onboarding";
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-2xl border border-border bg-card/60 p-10 shadow-elegant backdrop-blur">
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Sign in to launch Facebook ads at scale.
            </p>
          </div>
          ...
          <Button
            ...
            size="lg"
            className="w-full bg-gradient-primary text-primary-foreground shadow-glow transition-smooth hover:opacity-90"
          >
            <GoogleIcon />
